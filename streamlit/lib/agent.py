...
2. key_points → esplora ogni key point ({kp_list}) uno alla volta con UNA sola domanda aperta; se la risposta è sufficiente passa subito al key point successivo senza ulteriori approfondimenti; solo se la risposta è troppo vaga o brevissima puoi fare al massimo UNA domanda di chiarimento, poi vai avanti comunque; accumula le risposte in key_points_data
